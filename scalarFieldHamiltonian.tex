...
In \citep{LukeQFT} it is left as an exercise to expand the scalar field Hamiltonian in terms of the raising and lowering operators.  Let's do that.
} % problem
...
d^3 j
d^3 k
\inv{ \sqrt{ 4 \omega_j \omega_k } } \,\times \\
&\quad\biglr{
 a_\Bj e^{-i \omega_j t }
+a_{-\Bj}^\dagger e^{i \omega_j t }
}
