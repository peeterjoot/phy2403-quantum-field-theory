...
\end{dmath}
\paragraph{FIXME: Where did all these terms downstairs come from?  They weren't in \cref{eqn:qftLecture17:320}.  Is this a new quantity mislabeled?}
...
\inv{V_3}
\lr{
   \frac{\Abs{\Bk_A}}{\omega_{k_A}}
   +
   \frac{\Abs{\Bk_B}}{\omega_{k_B}}
}
=
