...
\times \Abs{ M_{fi} }^2,
\end{equation}
where the proportionality is because we will have to divide by all the norms of the final states\footnote{Required for the probability to be no greater than one.}.
