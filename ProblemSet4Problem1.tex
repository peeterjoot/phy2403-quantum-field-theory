...
Notice also that the lemma \cref{lemma} holds also if the product $$:A_1 A_2 \ldots A_n:$$ is replaced by $$:A_1 \contraction{}{A}{{}_2\ldots}{A} A_2 \ldots  A_p \ldots A_n:,$$
...
\begin{aligned}
\contraction{}{a}{{}_{k_1}^\dagger \cdots a_{k_r}^\dagger a_{k_{r+1}} \cdots a_{k_n} }{a}
a_{k_1}^\dagger \cdots a_{k_r}^\dagger a_{k_{r+1}} \cdots a_{k_n} a_{k_{n+1}}
&= 0 \\
\contraction{a_{k_1}^\dagger }{a}{{}_{k_2}^\dagger \cdots a_{k_r}^\dagger a_{k_{r+1}} \cdots a_{k_n}}{a}
a_{k_1}^\dagger a_{k_2}^\dagger \cdots a_{k_r}^\dagger a_{k_{r+1}} \cdots a_{k_n} a_{k_{n+1}}
&= 0 \\
\vdots & \\
\contraction{a_{k_1}^\dagger \cdots a_{k_r}^\dagger a_{k_{r+1}} \cdots }{a}{{}_{k_n}}{a}
a_{k_1}^\dagger \cdots a_{k_r}^\dagger a_{k_{r+1}} \cdots a_{k_n} a_{k_{n+1}}
&= 0,
\end{aligned}.
\end{dmath}
...
\begin{aligned}
:A_1 A_2 \ldots A_n: B &=  :A_1 A_2 \ldots A_n  B: \\
\sum\limits_{1 \le k \le n}:A_1 \ldots \contraction{}{A}{{}_k \ldots A_n}{B} A_k \ldots A_n B: &= 0,
\end{aligned}
\end{dmath}
...
=
a_{k_1}^\dagger \cdots a_{k_r}^\dagger a_{k_{r+1}} \cdots a_{k_n} a_{k_{n+1}}^\dagger
=
a_{k_1}^\dagger \cdots a_{k_r}^\dagger
a_{k_{r+1}}
\cdots
a_{k_{n-1}}
\lr{
