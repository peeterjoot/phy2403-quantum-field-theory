...
Notice also that the lemma (\ref{lemma}) holds also if the product $$:A_1 A_2 \ldots A_n:$$ is replaced by $$:A_1 \contraction{}{A}{{}_2\ldots}{A} A_2 \ldots  A_p \ldots A_n:,$$
...
Now prove the actual Wick theorem (\ref{w1}). Assuming that it holds for $n=2$. Imagine that (\ref{w1}) holds for $n$ operators and prove that it holds for $n+1$, using (\ref{lemma}).
