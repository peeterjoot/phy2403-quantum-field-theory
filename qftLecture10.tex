...
where the space of all possible Lorentz transformations move along the surface of the parabaloid, we argue that \( \Theta(p^0) \) is Lorentz invariant, since the sign of the energy \( p^0 \) does not change under such a transformation.
