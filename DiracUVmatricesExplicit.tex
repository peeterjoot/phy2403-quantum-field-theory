...
\Cref{eqn:squarerootpsigma:220} is probably a much nicer starting point for evaluating the various \( u, v, \ubar, \vbar \) product relationships.  In particular, again using Mathematica \nbref{uvspinors.nb}, this is a nice representation for showing that
