...
%
\makeproblem{One dimensional string}{qft:LukeProblemSet1:3}{
...
\begin{dmath}\label{eqn:LukeProblemSet1Problem3:20}
...
\begin{dmath}\label{eqn:LukeProblemSet1Problem3:40}
y(x,t) = \sqrt{\frac{2}{a}} \sum_{n=1}^\infty \sin\lr{ \frac{ n \pi x }{a} } q_n(t)
\end{dmath}

show that the Lagrangian becomes

\begin{dmath}\label{eqn:LukeProblemSet1Problem3:60}
