...
\begin{equation}\label{eqn:LukeProblemSet1Problem2:20}
...
\begin{equation}\label{eqn:LukeProblemSet1Problem2:40}
\bra{z} X \ket{z} = \sqrt{\frac{2}{\mu\omega}} z \cos\omega t
\end{equation}
\begin{equation}\label{eqn:LukeProblemSet1Problem2:60}
...
\begin{equation}\label{eqn:qftProblemSet1Problem2:80}
...
\begin{equation}\label{eqn:qftProblemSet1Problem2:160}
\begin{aligned}
1 &= \braket{z}{z}
...
\begin{equation}\label{eqn:qftProblemSet1Problem2:260}
\begin{aligned}
a \ket{z}
&=
a N
...
\begin{equation}\label{eqn:qftProblemSet1Problem2:200}
\begin{aligned}
\braket{z}{z'}
&=
...
\begin{equation}\label{eqn:qftProblemSet1Problem2:280}
\begin{aligned}
\bra{z} a^\dagger
&=
\lr{ a \ket{z} }^\dagger
...
\end{equation}
so
\begin{equation}\label{eqn:qftProblemSet1Problem2:240}
\begin{aligned}
\bra{z} H \ket{z}
&=
\omega
...
\begin{equation}\label{eqn:qftProblemSet1Problem2:300}
\begin{aligned}
\bra{q} a \ket{z}
&=
...
\begin{equation}\label{eqn:qftProblemSet1Problem2:320}
\lr{ z - \frac{q}{\sqrt{2}} } \psi = \inv{\sqrt{2}} \PD{q}{\psi},
\end{equation}
which separates into
\begin{equation}\label{eqn:qftProblemSet1Problem2:340}
\lr{ \sqrt{2} z - q} dq = \frac{d\psi}{\psi}.
\end{equation}

The solution is of the form
\begin{equation}\label{eqn:qftProblemSet1Problem2:360}
\begin{aligned}
\psi
...
\begin{equation}\label{eqn:qftProblemSet1Problem2:380}
\begin{aligned}
\bra{z} X \ket{z}
&=
\inv{\sqrt{\mu \omega}}
...
\end{aligned}
\end{equation}
\begin{equation}\label{eqn:qftProblemSet1Problem2:400}
\begin{aligned}
\bra{z} P \ket{z}
&=
\sqrt{\mu \omega}
