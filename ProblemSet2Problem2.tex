...
\end{dmath}
This clearly also satisfies the angular momentum commutation relations.  The charges \( Q^a_R, Q^b_L \) should commute by
virtue of originating from two independent symmetries.
}
