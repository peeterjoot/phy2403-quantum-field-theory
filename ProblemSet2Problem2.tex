...
%
\makeoproblem{A \(\SU{2}_L \times \SU{2}_R\) model.}
% A model with \(\SU{2}_L \times \SU{2}_R\) internal global symmetry: chiral symmetry and the Higgs
{qft:problemSet2:2}{2018 Hw2.II}{
...
It is given by:
\begin{equation}\label{eqn:ProblemSet2Problem2:10} %(1)
...
\begin{equation}\label{eqn:ProblemSet2Problem2:20} % , (2)
...
%
\begin{equation}\label{eqn:ProblemSet2Problem2:520}
...
\begin{equation}\label{eqn:ProblemSet2Problem2:40}
H^\dagger H = \inv{2}
\begin{bmatrix}
...
can be written as
\begin{equation}\label{eqn:ProblemSet2Problem2:50}
\LL = \trace{
   \lr{
...
acting on \( H \) as
\begin{equation}\label{eqn:ProblemSet2Problem2:60}
...
\begin{equation}\label{eqn:ProblemSet2Problem2:760}
...
\begin{equation}\label{eqn:ProblemSet2Problem2:80}
\begin{aligned}
...
\begin{equation}\label{eqn:ProblemSet2Problem2:100}
\begin{aligned}
...
\begin{equation}\label{eqn:ProblemSet2Problem2:120}
\begin{aligned}
\delta \Phi
&= \Phi' - \Phi
...
\end{equation}
so
\begin{equation}\label{eqn:ProblemSet2Problem2:140}
\begin{aligned}
...
\end{equation}
and
\begin{equation}\label{eqn:ProblemSet2Problem2:160}
\begin{aligned}
...
\begin{equation}\label{eqn:ProblemSet2Problem2:180}
\begin{aligned}
j^\mu_\Bomega
&=
...
\end{equation}
or
\begin{equation}\label{eqn:ProblemSet2Problem2:200}
j^{\mu a} =
\frac{i}{2}
\lr{
...
\begin{equation}\label{eqn:ProblemSet2Problem2:220}
\begin{aligned}
\delta \Phi
&= \Phi' - \Phi
...
\end{equation}
so
\begin{equation}\label{eqn:ProblemSet2Problem2:240}
\begin{aligned}
\delta (\Phi^\dagger \Phi)
&=
(\delta \Phi^\dagger) \Phi
...
\end{equation}
and
\begin{equation}\label{eqn:ProblemSet2Problem2:260}
\begin{aligned}
\delta (\partial_\mu \Phi^\dagger \partial^\mu \Phi)
&=
\partial_\mu (\delta \Phi^\dagger) \partial^\mu \Phi
...
\begin{equation}\label{eqn:ProblemSet2Problem2:280}
\begin{aligned}
j^\mu_\alpha
&=
\PD{(\partial_\mu \Phi)}{\LL} \delta \Phi
...
\begin{equation}\label{eqn:ProblemSet2Problem2:300}
\begin{aligned}
Q^a
&= \frac{i}{2} \int d^3 x
\lr{
...
\begin{equation}\label{eqn:ProblemSet2Problem2:980}
=
\frac{i}{2} \int d^3 x
\lr{
...
\begin{equation}\label{eqn:ProblemSet2Problem2:320}
\begin{aligned}
...
\end{aligned}
\end{equation}
Each of these commutators has a \( \deltathree(\Bx - \By) \) term, leaving
\begin{equation}\label{eqn:ProblemSet2Problem2:340}
\begin{aligned}
\antisymmetric{Q^a}{Q^b}
&=
\frac{i}{4} \int d^3 x
...
\begin{equation}\label{eqn:ProblemSet2Problem2:360}
\begin{aligned}
\Phi^\dagger \Phi
&=
\phi_1^\dagger \phi_1
...
\begin{equation}\label{eqn:ProblemSet2Problem2:380}
\Phi^\dagger \Phi = \Psi^\T \Psi,
\end{equation}
so \( b, c = 1 \).  For the derivative term, we have
\begin{equation}\label{eqn:ProblemSet2Problem2:400}
\begin{aligned}
\partial_\mu \Phi^\dagger \partial^\mu \Phi
&=
...
\begin{equation}\label{eqn:ProblemSet2Problem2:420}
\partial_\mu \Phi^\dagger \partial^\mu \Phi = \partial_\mu \Psi^\T \partial^\mu \Psi,
\end{equation}
so \( a = 1 \).

For the question of the \( U(1) \) symmetry, suppose that \( \Psi \rightarrow e^{i\alpha} \Psi \).  We then have
\begin{equation}\label{eqn:ProblemSet2Problem2:440}
...
\begin{equation}\label{eqn:ProblemSet2Problem2:460}
...
\begin{equation}\label{eqn:ProblemSet2Problem2:500}
\begin{aligned}
\sigma^2 (U_L\Phi)^\conj
&\rightarrow
...
\begin{equation}\label{eqn:ProblemSet2Problem2:560}
\begin{aligned}
H
...
\begin{equation}\label{eqn:ProblemSet2Problem2:540}
\sigma^2 U_L^\conj = U_L \sigma^2,
\end{equation}
the identity that was claimed to be important for future spinor theory work.
\makeSubAnswer{}{qft:problemSet2:2e}
\begin{equation}\label{eqn:ProblemSet2Problem2:580}
\begin{aligned}
H^\dagger H
&=
\inv{2}
...
\begin{equation}\label{eqn:ProblemSet2Problem2:600}
H^\dagger H = \inv{2}
\begin{bmatrix}
\Abs{\phi_1}^2 + \Abs{\phi_2}^2 & 0 \\
0 & \Abs{\phi_1}^2 + \Abs{\phi_2}^2
...
\end{equation}
and
\begin{equation}\label{eqn:ProblemSet2Problem2:620}
\begin{aligned}
\trace{
   H^\dagger H
}
...
\begin{equation}\label{eqn:ProblemSet2Problem2:640}
\partial_\mu H^\dagger \partial^\mu H
=
\begin{bmatrix}
...
\begin{equation}\label{eqn:ProblemSet2Problem2:720}
\partial_\mu H^\dagger \partial^\mu H
=
\begin{bmatrix}
...
\end{equation},
so
\begin{equation}\label{eqn:ProblemSet2Problem2:660}
...
\begin{equation}\label{eqn:ProblemSet2Problem2:680}
\begin{aligned}
\partial_\mu H^\dagger \partial^\mu H
&\rightarrow
...
\begin{equation}\label{eqn:ProblemSet2Problem2:700}
\begin{aligned}
 H^\dagger  H
 &\rightarrow
...
\begin{equation}\label{eqn:ProblemSet2Problem2:740}
\begin{aligned}
\delta H
&= H' - H
\\&\approx
...
\begin{equation}\label{eqn:ProblemSet2Problem2:780}
\LL = \trace{\lr{ \partial_\mu H^\dagger \partial^\mu H + V(H^\dagger H)}}.
\end{equation}

That is
\begin{equation}\label{eqn:ProblemSet2Problem2:800}
\begin{aligned}
\delta S
&=
\delta \int d^4 x
...
\begin{equation}\label{eqn:ProblemSet2Problem2:860}
\delta S =
\int d^4 x
   \partial_\mu
   \trace{\lr{
...
\begin{equation}\label{eqn:ProblemSet2Problem2:820}
   \partial_\mu
   \trace{\lr{
   \delta H^\dagger \partial^\mu H
   +
...
\begin{equation}\label{eqn:ProblemSet2Problem2:840}
j^\mu =
   \trace{\lr{
   \delta H^\dagger \partial^\mu H
   +
...
\begin{equation}\label{eqn:ProblemSet2Problem2:880}
\begin{aligned}
H &= \inv{\sqrt{2}}
\begin{bmatrix}
...
\end{equation}
which gives
\begin{equation}\label{eqn:ProblemSet2Problem2:900}
\begin{aligned}
\trace{\lr{
...
\begin{equation}\label{eqn:ProblemSet2Problem2:920}
\begin{aligned}
j_L^\mu
&=
   \trace{\lr{
...
\begin{equation}\label{eqn:ProblemSet2Problem2:940}
\begin{aligned}
j_R^\mu
&=
   \trace{\lr{
...
%
\begin{equation}\label{eqn:ProblemSet2Problem2:960}
\begin{aligned}
j^{\mu, a}_L
&=
\frac{i}{2} \trace{\lr{
...
\end{aligned}
\end{equation}
These matrix products expand to
\begin{equation}\label{eqn:ProblemSet2Problem2:1140}
\begin{bmatrix}
...
\end{equation}
so
\begin{equation}\label{eqn:ProblemSet2Problem2:1160}
\begin{aligned}
j^{\mu, a}_L
&=
\frac{i}{4}
...
\begin{equation}\label{eqn:ProblemSet2Problem2:1000}
Q^{a}_L
=
\frac{i}{2}
\int d^3 x
...
\begin{equation}\label{eqn:ProblemSet2Problem2:1020}
\Psi =
\begin{bmatrix}
\phi_2 \\
\phi_1^\conj
...
\begin{equation}\label{eqn:ProblemSet2Problem2:1040}
\begin{aligned}
H &=
\inv{\sqrt{2}}
\begin{bmatrix}
...
\begin{equation}\label{eqn:ProblemSet2Problem2:1060}
\begin{aligned}
j^{\mu, a}_R
&=
\frac{i}{2} \trace{\lr{
...
\begin{equation}\label{eqn:ProblemSet2Problem2:1080}
Q^{a}_R
=
\frac{i}{2}
\int d^3 x
...
\begin{equation}\label{eqn:ProblemSet2Problem2:1100}
\begin{aligned}
...
\end{equation}
so
\begin{equation}\label{eqn:ProblemSet2Problem2:1120}
\begin{aligned}
