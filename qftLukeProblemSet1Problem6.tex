...
{2015 ps1.6}
{
(You can probably find this worked out in lots of places\footnote{Including Hw1 from 2018 QFT I \cref{qft:problemSet1:1}, although that problem didn't include the mass term.}, but it's good practice with working with four-vectors, so I strongly encourage you to do it yourself!)
Consider the Lagrangian for a real vector field \( A^\mu \):
\begin{equation}\label{eqn:LukeProblemSet1Problem6:20}
\LL
=
- \inv{2}
...
\begin{equation}\label{eqn:LukeProblemSet1Problem6:40}
...
\begin{equation}\label{eqn:LukeProblemSet1Problem6:60}
...
\begin{equation}\label{eqn:LukeProblemSet1Problem6:120}
\LL
=
- \inv{2}
\partial_\alpha A_\beta(x) \partial^\alpha A^\beta(x)
...
%
to compute
\begin{equation}\label{eqn:qftProblemSet1Problem6:140}
...
%
or
\begin{equation}\label{eqn:qftProblemSet1Problem6:160}
0
=
-
...
\begin{equation}\label{eqn:qftProblemSet1Problem6:180}
0 =
\lr{ -
...
\begin{equation}\label{eqn:qftProblemSet1Problem6:200}
\begin{aligned}
0
&= \delSquaredBox A_\nu
...
\begin{equation}\label{eqn:qftProblemSet1Problem6:220}
F_{0 k}
=
...
\begin{equation}\label{eqn:qftProblemSet1Problem6:240}
F_{12}
=
...
\begin{equation}\label{eqn:qftProblemSet1Problem6:280}
0
=
\partial^k F_{k 0}
=
...
\begin{equation}\label{eqn:qftProblemSet1Problem6:300}
\begin{aligned}
0
&=
...
\begin{equation}\label{eqn:qftProblemSet1Problem6:320}
