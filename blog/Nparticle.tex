...
\begin{dmath}\label{eqn:Nparticle:100}
H_{\text{int}}
=
\lambda \int \frac{ d^3 p d^3 k d^3 q }{4 (2 \pi)^{9} }
\lr{
...
takes the form
\begin{dmath}\label{eqn:Nparticle:120}
\text{\(:H:\)} =
...
\begin{dmath}\label{eqn:Nparticle:140}
\text{\(:H:\)} =
\sum_{i = 1}^N \omega_{\Bp_i} a_{\Bp_i}^\dagger a_{\Bp_i}
+
\frac{
...
\begin{dmath}\label{eqn:Nparticle:160}
\text{\(:H:\)} =
\sum_{i = 1}^N \omega_{\Bp_i} a_{\Bp_i}^\dagger a_{\Bp_i}
+
\frac{
...
\begin{dmath}\label{eqn:Nparticle:170}
\text{\(:H:\)} =
...
\begin{dmath}\label{eqn:Nparticle:190}
H_{\text{int}}
=
...
\begin{dmath}\label{eqn:Nparticle:210}
...
\begin{dmath}\label{eqn:Nparticle:230}
H \ket{\Bp_1 \Bp_2}
=
\lr{
   \int \frac{d^3}{(2 \pi)^3}
...
\begin{dmath}\label{eqn:Nparticle:250}
\int
