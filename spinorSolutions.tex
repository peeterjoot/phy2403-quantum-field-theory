...
\begin{dmath}\label{eqn:spinorSolutions:20}
\gamma^0 =
\begin{bmatrix}
0 & 1 \\
1 & 0
...
\begin{dmath}\label{eqn:spinorSolutions:40}
\gamma^0 =
\begin{bmatrix}
1 & 0 \\
0 & -1
...
\begin{dmath}\label{eqn:spinorSolutions:60}
\begin{aligned}
...
\end{dmath}
or
\begin{dmath}\label{eqn:spinorSolutions:80}
\begin{aligned}
...
\begin{dmath}\label{eqn:spinorSolutions:100}
\begin{aligned}
...
\begin{dmath}\label{eqn:spinorSolutions:120}
\begin{aligned}
...
\begin{dmath}\label{eqn:spinorSolutions:140}
\begin{aligned}
u(p) &= (\slashed{p} + m) \psi \\
v(p) &= (\slashed{p} - m) \psi
\end{aligned}
...
\begin{dmath}\label{eqn:spinorSolutions:260}
\psi
=
\begin{bmatrix}
\phi \\
...
\begin{dmath}\label{eqn:spinorSolutions:160}
\begin{aligned}
\gamma^0 - 1 &=
\begin{bmatrix}
1 & 0 \\
...
\end{dmath}
so we have
\begin{dmath}\label{eqn:spinorSolutions:280}
\begin{aligned}
u(E, \Bzero) &=
\begin{bmatrix}
2 & 0 \\
...
\begin{dmath}\label{eqn:spinorSolutions:180}
u(E, \Bzero) \in \setlr{
\begin{bmatrix}
1 \\
0 \\
...
\begin{dmath}\label{eqn:spinorSolutions:200}
v(E, \Bzero) \in \setlr{
\begin{bmatrix}
0 \\
0 \\
...
\begin{dmath}\label{eqn:spinorSolutions:220}
\begin{aligned}
u^a(E, \Bzero) &=
\begin{bmatrix}
\zeta^a \\
...
\begin{dmath}\label{eqn:spinorSolutions:240}
\begin{aligned}
\slashed{p} - m
&=
p_0
...
\begin{dmath}\label{eqn:spinorSolutions:300}
\begin{aligned}
...
\begin{dmath}\label{eqn:spinorSolutions:320}
\begin{aligned}
u^a(p) &=
\begin{bmatrix}
(E + m) \zeta^a \\
...
\end{aligned}
\end{dmath}
where an overall sign on \( v^a(p) \) has been dropped.  Let's check these
\begin{dmath}\label{eqn:spinorSolutions:340}
...
\end{dmath}
and
\begin{dmath}\label{eqn:spinorSolutions:360}
