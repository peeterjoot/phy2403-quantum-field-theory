...
\lr{ 1 + h }^4
=
\frac{\Abs{m}^2}{2 \lambda} \LL',
\end{dmath}
where \( \LL' \) is the ``canonically normalized'' Lagrangian
...
\end{dmath}
This answers the question of the constant, which we find is \( 2 \) after the canonical normalization.
