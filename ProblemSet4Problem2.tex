...
\begin{equation}\label{eqn:ProblemSet4Problem2:501}
\begin{aligned}
\LL
&=
\frac{\Abs{m}^2}{2 \lambda}
...
(2 \pi)^4  \\
&\quad
\deltathree(\Bp_1 + \Bp_2 - \Bk) 
\delta(\omega_{\Bp_1} + \omega_{\Bp_2} - \omega_\Bk)
(-p_1 \cdot p_2)^2.
\end{aligned}
\end{equation}
...
\begin{equation}\label{eqn:ProblemSet4Problem2:1140}
\begin{aligned}
\Gamma
&=
\inv{v^2}
