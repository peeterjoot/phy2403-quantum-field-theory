...
\end{dmath}
\maketheorem{Dirac Hamiltonian in terms of creation and annihilation operators.}{thm:qftLecture21b:7}{
...
We'll end up dropping the vacuum energy term.  We'll end up labelling the \( a \)'s as the operators associated with electrons, and the \( b \)'s with anti-electrons.
