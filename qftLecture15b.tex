...
\begin{equation}\label{eqn:qftLecture15b:20}
D_F(1-2) \equiv D_F(x_1, x_2),
\end{equation}
and second
\begin{equation}\label{eqn:qftLecture15b:40}
...
\begin{equation}\label{eqn:qftLecture15b:60}
\begin{aligned}
...
For \( n = 4 \) we have
\begin{equation}\label{eqn:qftLecture15b:120}
...
\imageFigure{../figures/phy2403-quantum-field-theory/qftLecture15bFig1}{Simplest Feynman diagrams.}{fig:qftLecture15b:qftLecture15bFig1}{0.12}
...
\begin{equation}\label{eqn:qftLecture15b:140}
...
\begin{equation}\label{eqn:qftLecture15b:340}
\begin{aligned}
...
\begin{equation}\label{eqn:qftLecture15b:360}
...
\imageFigure{../figures/phy2403-quantum-field-theory/qftLecture15bFigF2a}{First integral diagram.}{fig:qftLecture15b:qftLecture15bFigF2a}{0.08}
...
{Second integral diagrams.}{fig:qftLecture15b:qftLecture15bFigF2b}{scale=0.2}

We can depict the entire second integral in diagrams as sketched in \cref{fig:qftLecture15b:qftLecture15bFig3}.
\imageFigure{../figures/phy2403-quantum-field-theory/qftLecture15bFig3}{Integrals as diagrams.}{fig:qftLecture15b:qftLecture15bFig3}{0.2}
...
\begin{equation}\label{eqn:qftLecture15b:380}
...
\imageFigure{../figures/phy2403-quantum-field-theory/qftLecture15bFig5}{Figure eight diagram.}{fig:qftLecture15b:qftLecture15bFig5}{0.1}
represents
\begin{equation}\label{eqn:qftLecture15b:400}
\int d^4 z D_F^2(z - z)
=
...
\begin{equation}\label{eqn:qftLecture15b:420}
...
\imageFigure{../figures/phy2403-quantum-field-theory/qftLecture15bFig7}{First order interaction diagrams.}{fig:qftLecture15b:qftLecture15bFig7}{0.12}
