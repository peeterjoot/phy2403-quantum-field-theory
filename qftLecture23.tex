...
\index{QED Lagrangian}
\index{QCD Lagrangian}
\index{Feynman propagator}
\index{Feynman rules!fermions}
\index{hadron pair production}
\index{scattering cross section}
\index{quark pair production}
...
Our Lagrangian is
\begin{equation}\label{eqn:qftLecture23:140}
...
\begin{equation}\label{eqn:qftLecture23:160}
\Psi(x) =
\sum_{s = 1}^2
...
\end{equation}
\begin{equation}\label{eqn:qftLecture23:180}
\oPsi(x)
=
\sum_{s = 1}^2
\int \frac{d^3 p}{(2 \pi)^3 \sqrt{2 \omega_\Bp}}
...
\begin{equation}\label{eqn:qftLecture23:200}
\symmetric{a_\Bp^s}{a_\Bq^{r\dagger}} = (2 \pi)^3 \delta^{sr} \deltathree( \Bp - \Bq),
\end{equation}
\begin{equation}\label{eqn:qftLecture23:201}
...
\begin{equation}\label{eqn:qftLecture23:20}
\Psi(x) \rightarrow e^{i \alpha(x) } \Psi(x),
\end{equation}
which has derivatives
\begin{equation}\label{eqn:qftLecture23:280}
...
\begin{equation}\label{eqn:qftLecture23:80}
\begin{aligned}
\LL_{\text{QED}}
&=
- \inv{4} F_{\mu\nu} F^{\mu\nu}
...
\begin{equation}\label{eqn:qftLecture23:100}
...
\begin{equation}\label{eqn:qftLecture23:120}
...
\begin{equation}\label{eqn:qftLecture23:220}
T( O_f(x) O'_f(x)) =
...
\begin{equation}\label{eqn:qftLecture23:240}
...
\begin{equation}\label{eqn:qftLecture23:260}
\begin{aligned}
...
\begin{equation}\label{eqn:qftLecture23:340}
\begin{aligned}
&\expectation{ T( \Psi_\alpha(x) \Psi_\beta(x) }_0 \\
&=
\Theta ( x_0 - y_0 )
...
\begin{equation}\label{eqn:qftLecture23:360}
\begin{aligned}
\expectation{ T( \Psi_\alpha(x) \Psi_\beta(x) }_0
&=
...
\begin{equation}\label{eqn:qftLecture23:380}
...
\imageFigure{../figures/phy2403-quantum-field-theory/l23Fig1}{Electron, positron decay to muon pairs.}{fig:l23:l23Fig1}{0.15}
\imageFigure{../figures/phy2403-quantum-field-theory/l23Fig2}{Electron, positron collision.}{fig:l23:l23Fig2}{0.15}
\imageFigure{../figures/phy2403-quantum-field-theory/l23Fig3}{Compton scattering.}{fig:l23:l23Fig3}{0.15}

To do so we need to determine the Feynman rules for fermions.  For fermions \( \Psi \) and anti-fermions \( \oPsi \) we have
\begin{equation}\label{eqn:qftLecture23:440}
\begin{aligned}
...
\end{equation}
where we mean
\begin{equation}\label{eqn:qftLecture23:460}
\ket{\Bp, s} = a_\Bp^{s\dagger} \ket{0} \sqrt{ 2 \omega_\Bp },
\end{equation}
for fermions, and
\begin{equation}\label{eqn:qftLecture23:480}
...
\imageFigure{../figures/phy2403-quantum-field-theory/l23Fig4}{Flow of \# charge.}{fig:l23:l23Fig4}{0.15}

The Feynman propagator for fermions is
\begin{equation}\label{eqn:qftLecture23:500}
\frac{ i \lr{ \slashed{p} + m } }{p^2 - m^2 + i \epsilon},
\end{equation}
whereas the photon propagator is
\begin{equation}\label{eqn:qftLecture23:520}
\expectation{ A_\mu A_\nu } = -i \frac{g_{\mu\nu}}{q^2 + i \epsilon}.
\end{equation}
%\section{Example: \( e^{-} e^{+} \rightarrow \mu^{-} \mu^{+} \).}
\section{Example: \texorpdfstring{\( e^{-} e^{+} \rightarrow \mu^{-} \mu^{+} \)}{electron-antielectron to muons process}.}
As an example, consider the process sketched in \cref{fig:l23:l23Fig5}.
\imageFigure{../figures/phy2403-quantum-field-theory/l23Fig5}{\( e^{-} e^{+} \rightarrow \mu^{-} \mu^{+} \) process.}{fig:l23:l23Fig5}{0.2}
...
\begin{equation}\label{eqn:qftLecture23:540}
\begin{aligned}
...
\begin{equation}\label{eqn:qftLecture23:560}
i M = i \frac{e^2}{q^2}
...
\begin{equation}\label{eqn:qftLecture23:600}
\Abs{M}^2
=
\frac{e^4}{q^4}
\lr{
...
\begin{equation*}%\label{eqn:qftLecture23:620}
\rho_{\text{in}} = \sum_{s s'} \ket{s s'} \inv{4} \bra{ s s'}.
\end{equation*}
\begin{equation*}%\label{eqn:qftLecture23:640}
\trace{
\lr{
...
\begin{equation}\label{eqn:qftLecture23:610}
\begin{aligned}
...
\begin{equation}\label{eqn:qftLecture23:660}
\begin{aligned}
&\sum_{r'}
\vbar^{r'}(k')
\gamma_\rho
...
\begin{equation}\label{eqn:qftLecture23:680}
\begin{aligned}
\inv{4} &\sum_{ss', rr'} \Abs{M}^2
\\&=
\frac{e^4}{4 q^4}
...
\begin{equation}\label{eqn:qftLecture23:780}
\begin{aligned}
\trace{\lr{
...
\begin{equation}\label{eqn:qftLecture23:800}
\begin{aligned}
&\trace{ \lr{
\lr{ \slashed{k'} - m_\mu }
\gamma_\nu
...
\begin{equation}\label{eqn:qftLecture23:820}
...
\imageFigure{../figures/phy2403-quantum-field-theory/l23Fig6}{Electron center of mass frame.}{fig:l23:l23Fig6}{0.2}
Let \( q \) represent the total rest frame four momentum
\begin{equation}\label{eqn:qftLecture23:840}
q = p + p' = (2 E, \Bzero),
\end{equation}
where \( q^2 = 4 E^2 \).
We also have
...
\begin{equation}\label{eqn:qftLecture23:860}
\begin{aligned}
p \cdot p'
...
\end{aligned}
\end{equation}
\begin{equation}\label{eqn:qftLecture23:880}
\begin{aligned}
p \cdot k
&= (E, E \zcap) \cdot (E, \Bk) \\
...
\end{aligned}
\end{equation}
\begin{equation}\label{eqn:qftLecture23:900}
\begin{aligned}
p \cdot k'
&= (E, E \zcap) \cdot (E, -\Bk) \\
&= E^2 - (E \zcap) \cdot( -\Bk) \\
...
\end{aligned}
\end{equation}
\begin{equation}\label{eqn:qftLecture23:920}
\begin{aligned}
p' \cdot k'
&= (E, -E \zcap) \cdot (E, -\Bk) \\
&= E^2 - (-E \zcap) \cdot( -\Bk) \\
...
\end{aligned}
\end{equation}
\begin{equation}\label{eqn:qftLecture23:940}
\begin{aligned}
p' \cdot k
&= (E, -E \zcap) \cdot (E, \Bk) \\
&= E^2 -(-E \zcap) \cdot \Bk \\
...
\end{subequations}
but
\begin{equation}\label{eqn:qftLecture23:980}
\Bk^2 = E^2 - m_\mu^2,
\end{equation}
or
\begin{equation}\label{eqn:qftLecture23:1000}
\Norm{\Bk} = E \sqrt{ 1 - \frac{m_\mu^2}{E^2} }.
\end{equation}
We can now put the pieces back together and almost have the non-polarized cross section
\begin{equation}\label{eqn:qftLecture23:1020}
\begin{aligned}
\inv{4} \sum_{\text{spins}} \Abs{M}^2
&=
\frac{ 8 e^4}{ (4 E^2)^2 }
...
\begin{equation}\label{eqn:qftLecture23:1060}
...
\begin{equation}\label{eqn:qftLecture23:1080}
\begin{aligned}
&{\frac{d\sigma}{d\Omega}}_{\text{CM}} \\
&=
...
\begin{equation}\label{eqn:qftLecture23:1100}
\begin{aligned}
\sigma_{\text{total}}
...
\begin{equation}\label{eqn:qftLecture23:1140}
\sigma_{\text{total}} \sim \frac{\alpha^2}{s},
\end{equation}
whereas for \( E \gg m_\mu \) we've now found
\begin{equation}\label{eqn:qftLecture23:1160}
\sigma_{\text{total}}
=
\frac{4 \pi \alpha^2}{3 E_{\text{CM}}^2 }.
\end{equation}
...
\section{Measurement of intermediate quark scattering.}
\index{quark scattering}
...
\imageFigure{../figures/phy2403-quantum-field-theory/l23Fig7}{Electron and muon halves of the diagram}{fig:l23:l23Fig7}{0.15}
with anything else that is charged, as sketched in
\cref{fig:l23:l23Fig8}.
\imageFigure{../figures/phy2403-quantum-field-theory/l23Fig8}{Alternate charged pair production.}{fig:l23:l23Fig8}{0.2}
...
\imageFigure{../figures/phy2403-quantum-field-theory/l23Fig9}{Quark pair production.}{fig:l23:l23Fig9}{0.15}
...
\begin{equation}\label{eqn:qftLecture23:1200}
\begin{aligned}
R
&=
\frac{
...
\imageFigure{../figures/phy2403-quantum-field-theory/l23Fig10}{\( R \) quark step function.}{fig:l23:l23Fig10}{0.2}
