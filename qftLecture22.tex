...
\imageFigure{../figures/phy2403-quantum-field-theory/lecture22AbyssFig1}{Unbounded potential well.}{fig:lecture22Abyss:lecture22AbyssFig1}{0.15}
\imageFigure{../figures/phy2403-quantum-field-theory/lecture22Fig2}{Unstable configuration (inverted pendulum).}{fig:lecture22:lecture22Fig2}{0.15}
...
\begin{equation}\label{eqn:qftLecture22:80}
\begin{aligned}
...
\begin{equation}\label{eqn:qftLecture22:100}
\begin{aligned}
H
...
\end{aligned}
\end{equation}
Fermions have negative zero-point energy \( -4 \times \) that of real massive scalar\footnote{%
\index{supersymmetry}
%\makedigression{
...
\begin{equation}\label{eqn:qftLecture22:120}
\begin{aligned}
a_\Bp^s \ket{0} &= 0 \\
b_\Bp^s \ket{0} &= 0,
\end{aligned}
...
\begin{equation}\label{eqn:qftLecture22:540}
\begin{aligned}
...
\LL(m = 0) = \Psi^\dagger i \partial_0 \Psi + \Bsigma \cdot \lr{ \Psi^\dagger (-i\spacegrad) \Psi },
\end{equation}
...
\maketheorem{Ladder form of the momentum operator.}{thm:qftLecture22:560}{
...
\begin{equation}\label{eqn:qftLecture22:720}
\begin{aligned}
...
\begin{equation}\label{eqn:qftLecture22:740}
...
\begin{equation}\label{eqn:qftLecture22:760}
...
\begin{equation}\label{eqn:qftLecture22:580}
\begin{aligned}
...
\end{equation}
we can now compute
\begin{equation}\label{eqn:qftLecture22:600}
\begin{aligned}
P^k
&=
...
\end{equation}
Using
\begin{equation}\label{eqn:qftLecture22:780}
\begin{aligned}
...
\begin{equation}\label{eqn:qftLecture22:620}
P^k
=
...
\begin{proof} (partial)
Introduce a state associated with a fermion creation operator
\begin{equation}\label{eqn:qftLecture22:660}
\ket{\Bq, r} = \sqrt{ 2 \omega_\Bq } a_\Bq^{r\dagger} \ket{0}.
\end{equation}
The action of the momentum operator on such as state is
\begin{equation}\label{eqn:qftLecture22:680}
\begin{aligned}
\BP
\ket{\Bq, r}
&=
...
\begin{equation}\label{eqn:qftLecture22:800}
\begin{aligned}
S^{12}
...
\begin{equation}\label{eqn:qftLecture22:220}
\Lambda_{1/2} =
1 - \frac{i \alpha}{2}
\begin{bmatrix}
\sigma^3 & 0 \\
...
\begin{equation}\label{eqn:qftLecture22:860}
\begin{aligned}
\Psi(\Lambda^{-1} x)
&=
...
\begin{equation}\label{eqn:qftLecture22:840}
\begin{aligned}
\delta \Psi
&=
...
%\begin{equation}\label{eqn:qftLecture22:880}
%\delta \Psi
%=
%- \frac{i \alpha}{2}
%\begin{bmatrix}
...
\begin{equation}\label{eqn:qftLecture22:240}
\begin{aligned}
j^\mu_\alpha
&=
\PD{(\partial_\mu \Psi)}{\LL}
...
\begin{equation}\label{eqn:qftLecture22:900}
J^0 = \int d^3 x
\lr{ \Psi^\dagger }
\lr{
   \frac{1}{2}
...
\begin{equation}\label{eqn:qftLecture22:280}
\begin{aligned}
...
\section{\texorpdfstring{\(U(1)_V\)}{U(1) vector} symmetry: charge!}
%\section{U(1) vector symmetry: charge!}
\index{symmetry!\(U(1)_V\)}
\index{electronic charge}
We also have a \( U(1) \) global symmetry which implies charge.  If we let
\begin{equation}\label{eqn:qftLecture22:320}
\begin{aligned}
...
\end{equation}
then
\begin{equation}\label{eqn:qftLecture22:340}
\begin{aligned}
j^\mu
&= \PD{(\partial_\mu \Psi)}{\LL} \delta \Psi
...
\end{equation}
that is
\begin{equation}\label{eqn:qftLecture22:360}
...
\section{\texorpdfstring{\(U(1)_A\)}{U(1) axial} symmetry: what was the charge for this one called?}
%\section{U(1) axial symmetry: what was the charge for this one called?}
\index{symmetry!\(U(1)_A\)}
...
\begin{equation}\label{eqn:qftLecture22:700}
\begin{aligned}
\gamma_5^\dagger
&=
-i
...
\begin{equation}\label{eqn:qftLecture22:460}
\symmetric{\gamma_5}{\gamma^\mu} = 0.
\end{equation}
See \nbref{uvspinors.nb} for a proof.

Under this transformation
\begin{equation}\label{eqn:qftLecture22:480}
\begin{aligned}
\oPsi i \gamma^\mu \partial_\mu \Psi
&\rightarrow
...
Also
\begin{equation}\label{eqn:qftLecture22:500}
\begin{aligned}
m \oPsi \Psi
&\rightarrow
