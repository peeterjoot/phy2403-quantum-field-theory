...
The following is an attempt to show this, but it ends up with sign error that I've had trouble identifying.

Starting with the field representations (\citep{peskin1995introduction} eq. 3.99, 3.100)
...
This has a vacuum term that can be ignored, but I still end up with an overall sign error?
