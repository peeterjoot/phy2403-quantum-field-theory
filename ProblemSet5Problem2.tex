...
%
%{
\makeproblem{Problem II: Electromagnetic theory in 2+1 dimensions.}{qft:problemSet5:2}{
See handout for full problem description.
...
By this criteria the \( c \) coupling is relevant, since it has a positive mass dimension.  Since it is also the only coupling, it is also the most relevant coupling, and my conclusion is that we are being asked whether the charge associated with the current calculated above is gauge invarient.
