...
%
\makeoproblem{
%Lorentz transforms of spinors---some useful identities.
Lorentz transforms of spinors.
}{qft:problemSet4:4}{2018 Hw4.IV}{
\index{spinor!Lorentz transform}
...
For infinitesimal transformations we can show this using the BCH theorem.  First let
...
\begin{equation}\label{eqn:ProblemSet4Problem4:100}
\begin{aligned}
\Lambda^{-1}_{1/2}
\gamma^\mu
\Lambda_{1/2}
...
\begin{equation}\label{eqn:ProblemSet4Problem4:120}
\Lambda_{1/2}
=
\begin{bmatrix}
...
\begin{equation}\label{eqn:ProblemSet4Problem4:140}
\begin{aligned}
\gamma^0
\begin{bmatrix}
a & 0 \\
...
\begin{equation}\label{eqn:ProblemSet4Problem4:160}
\begin{aligned}
...
\begin{equation}\label{eqn:ProblemSet4Problem4:180}
\gamma^0 \Lambda_{1/2}^\dagger \gamma^0
=
\Lambda^{-1}_{1/2},
\end{equation}
so
\begin{equation}\label{eqn:ProblemSet4Problem4:200}
...
\begin{equation}\label{eqn:ProblemSet4Problem4:220}
A^{\mu\nu} \rightarrow
\ulLambda{\mu}{\alpha}
\ulLambda{\nu}{\beta}
A^{\mu\nu}.
...
\begin{equation}\label{eqn:ProblemSet4Problem4:240}
\begin{aligned}
...
\begin{equation}\label{eqn:ProblemSet4Problem4:260}
\begin{aligned}
\inv{2} \overbar{\Psi}
