...
\end{dmath}
or
\begin{dmath}\label{eqn:qftLecture1:220}
...
\begin{aligned}
\Hbar \omega_\conj
&\sim 10^{-21} \si{MeV s} 10^{23} \si{1/s} \\
&\sim 100 \si{MeV}.
\end{aligned}
\end{dmath}
...
A value that is very useful in determining scale is
\begin{dmath}\label{eqn:qftLecture1:260}
