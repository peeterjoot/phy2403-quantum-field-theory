...
\begin{equation}\label{eqn:qftLecture21:20}
\LL_{\text{Dirac}} = \oPsi \lr{ i \gamma^\mu \partial_\mu -m } \Psi,
\end{equation}
from which we find
\begin{equation}\label{eqn:qftLecture21:40}
...
\begin{equation}\label{eqn:qftLecture21:60}
...
\begin{equation}\label{eqn:qftLecture21:80}
u^s(p) =
\begin{bmatrix}
...
\begin{proof}
\begin{equation}\label{eqn:qftLecture21:120}
u^{s \dagger} u^r
=
\begin{bmatrix}
...
%\begin{equation}\label{eqn:qftLecture21:1000}
%u^{s \dagger} u^{r}
%=
%2 p_0
%\zeta^{s\dagger} \zeta^r.
...
\begin{equation}\label{eqn:qftLecture21:1020}
\begin{aligned}
...
\end{proof}
%\begin{equation}\label{eqn:qftLecture21:140}
%u^{s \dagger} u^{s'}
...
\begin{proof}
\begin{equation}\label{eqn:qftLecture21:180}
(p \cdot \sigma) (p \cdot \osigma)
=
...
\end{equation}
and
\begin{equation}\label{eqn:qftLecture21:200}
(p \cdot \osigma) (p \cdot \sigma)
=
\lr{ p^0 + \Bp \cdot \Bsigma}
\lr{ p^0 - \Bp \cdot \Bsigma}
...
\begin{proof}
\begin{equation}\label{eqn:qftLecture21:160}
\ubar^r u^s
=
...
\begin{equation}\label{eqn:qftLecture21:260}
...
%and
%\begin{equation}\label{eqn:qftLecture21:480}
%\vbar^s
%= v^{s\dagger} \gamma_0.
%\end{equation}

It will also be useful to restate the \( 2 \delta^{rs} p_0 \) normalization conditions as
\begin{equation}\label{eqn:qftLecture21:1200}
\begin{aligned}
...
%\begin{equation}\label{eqn:qftLecture21:460}
...
\begin{proof}
For the \( v \)'s
\begin{equation}\label{eqn:qftLecture21:420}
\sum_{s = 1,2}
\begin{bmatrix}
\sqrt{p \cdot \sigma} \eta^s \\
-\sqrt{p \cdot \osigma} \eta^s \\
...
\end{equation}
but
\begin{equation}\label{eqn:qftLecture21:1120}
\eta^1 \otimes \eta^{1T}
=
\begin{bmatrix}
1 \\
...
\end{equation}
and
\begin{equation}\label{eqn:qftLecture21:1140}
\eta^2 \otimes \eta^{2T}
=
\begin{bmatrix}
0 \\
...
\begin{equation}\label{eqn:qftLecture21:1160}
