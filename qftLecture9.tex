...
\end{dmath}
or simply
\begin{dmath}\label{eqn:qftLecture9:n}
V(\phi)
=
...
We choose to expand around some point on the minimum ring, and it doesn't matter which one. % (P in the figure).
...
\begin{dmath}\label{eqn:qftLecture9:740}
{\Lambda^\mu}_\nu
g^{\nu\lambda}
...
=
\exp\lr{i \alpha_k
\int d^3 x x^i \pihat \partial^j \phihat
}
=
\exp\lr{i \Balpha
\int d^3 x \pihat \spacegrad \phi \cross \Bx
}
\end{dmath}
