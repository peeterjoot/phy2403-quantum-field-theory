...
= 0,
\end{dmath}
where cyclic permutation within the trace was used to arrange the terms for easy cancelation \(1 - 1 + 1 - 1 = 0\).
...
\end{dmath}
to quadratic order in \( \phi^a \).
The current, to lowest order in \( \phi^a \), and all orders in \( h \), is
\begin{dmath}\label{eqn:ProblemSet2Problem3:n}
j^{V,a}_\mu
=
2
