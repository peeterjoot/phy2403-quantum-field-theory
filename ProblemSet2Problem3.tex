...
%
\makeoproblem{%
Wigner and Nambu-Goldstone modes.%
%\( \SU{2}_L \times \SU{2}_R\), realized in the Wigner and Nambu-Goldstone modes.
}{qft:problemSet2:3}{2018 Hw2.III}{
...
We explore the \( \SU{2}_L \times \SU{2}_R\) symmetries in this model.
...
\begin{equation}\label{eqn:ProblemSet2Problem3:80}
...
\begin{equation}\label{eqn:ProblemSet2Problem3:120}
...
\begin{equation}\label{eqn:ProblemSet2Problem3:100}
...
\begin{equation}\label{eqn:ProblemSet2Problem3:140}
\begin{aligned}
\trace{\lr{
H^\dagger H
}}
...
\end{equation}
so we have
\begin{equation}\label{eqn:ProblemSet2Problem3:160}
\begin{aligned}
V 
&= -\Abs{m}^2
\trace{\lr{
...
\begin{equation}\label{eqn:ProblemSet2Problem3:180}
V
=
\lambda\lr{
      \Abs{\phi_1}^2 + \Abs{\phi_2}^2
...
\begin{equation}\label{eqn:ProblemSet2Problem3:200}
\LL = \partial_\mu \Phi^\dagger \partial^\mu \Phi + \Abs{m}^2 \Phi^\dagger \Phi.
\end{equation}
The equations of motion are
\begin{equation}\label{eqn:ProblemSet2Problem3:220}
\begin{aligned}
...
\end{equation}
so
\begin{equation}\label{eqn:ProblemSet2Problem3:280}
0 = -\omega^2 + \Bp^2 - \Abs{m}^2,
\end{equation}
or
\begin{equation}\label{eqn:ProblemSet2Problem3:300}
\omega = \sqrt{\Bp^2 - \Abs{m}^2}.
\end{equation}
Any \( \Norm{\Bp} < \Abs{m} \) results in an imaginary angular frequency.  For example, at \( \Bp = 0 \), we have
\begin{equation}\label{eqn:ProblemSet2Problem3:320}
\omega = \pm i \Abs{m}.
\end{equation}
In particular
\begin{equation}\label{eqn:ProblemSet2Problem3:340}
\begin{aligned}
p_0 x^0
&= \omega t
\\&= \pm i \Abs{m} t
...
\begin{equation}\label{eqn:ProblemSet2Problem3:380}
\begin{aligned}
\trace{\lr{H^\dagger H}}
&=
...
\begin{equation}\label{eqn:ProblemSet2Problem3:400}
\begin{aligned}
...
\begin{equation}\label{eqn:ProblemSet2Problem3:480}
\begin{aligned}
\partial_\mu h
\Omega^\dagger (\partial^\mu \Omega)
 +
...
\begin{equation}\label{eqn:ProblemSet2Problem3:500}
\LL =
\frac{\Abs{m}^2}{2 \lambda}
...
\begin{equation}\label{eqn:ProblemSet2Problem3:560}
\begin{aligned}
\LL_h
&=
\partial_\mu h \partial^\mu h
...
%
\begin{equation}\label{eqn:ProblemSet2Problem3:580}
\begin{aligned}
\partial_\mu \Omega
...
\begin{equation}\label{eqn:ProblemSet2Problem3:600}
\begin{aligned}
\LL_\Bphi 
&=
\inv{2} \trace{\lr{
...
\begin{equation}\label{eqn:ProblemSet2Problem3:640}
j^\mu
=
...
\begin{equation}\label{eqn:ProblemSet2Problem3:700}
\begin{aligned}
j^\mu
&=
...
\begin{equation}\label{eqn:ProblemSet2Problem3:720}
\begin{aligned}
\delta H
&=
H' - H
...
\begin{equation}\label{eqn:ProblemSet2Problem3:860}
\begin{aligned}
j_\mu^{V, \Bomega}
&= \frac{i}{2}
\trace{\lr{
...
\begin{equation}\label{eqn:ProblemSet2Problem3:780}
\begin{aligned}
\delta H
&=
H' - H
...
\delta H^\dagger = -\frac{i}{2} \symmetric{\Bsigma \cdot \Bomega}{H^\dagger}.
\end{equation}

Putting the pieces together gives
\begin{equation}\label{eqn:ProblemSet2Problem3:880}
\begin{aligned}
j_\mu^{A, \Bomega}
&= \frac{i}{2}
\trace{\lr{
...
\begin{equation}\label{eqn:ProblemSet2Problem3:820}
\begin{aligned}
\partial_\mu H
&=
\expectation{H}
...
\begin{equation}\label{eqn:ProblemSet2Problem3:840}
\begin{aligned}
\symmetric{\sigma^a}{H}
&=
\expectation{H}
...
\end{equation}
To first order
\begin{equation}\label{eqn:ProblemSet2Problem3:900}
\begin{aligned}
j^{A,a}_\mu
&=
...
\begin{equation}\label{eqn:ProblemSet2Problem3:920}
j^{A,a}_\mu = \expectation{H} \lr{ 4 \expectation{H} } \partial_\mu \phi^a,
\end{equation}
...
\begin{equation}\label{eqn:ProblemSet2Problem3:940}
...
\begin{equation}\label{eqn:ProblemSet2Problem3:980}
\partial_\mu H
=
...
\end{equation}
The current is
\begin{equation}\label{eqn:ProblemSet2Problem3:1000}
\begin{aligned}
j^{V,a}_\mu
&=
\frac{i}{2}
...
\end{equation}
where
\begin{equation}\label{eqn:ProblemSet2Problem3:1100}
\begin{aligned}
A &=
   \trace{\lr{
         \Omega^\dagger \antisymmetric{\sigma^a }{\Omega}
...
\begin{equation}\label{eqn:ProblemSet2Problem3:1020}
\begin{aligned}
A
&=
\trace{\lr{
...
\begin{equation}\label{eqn:ProblemSet2Problem3:1040}
\begin{aligned}
B
&=
\trace{\lr{
...
\begin{equation}\label{eqn:ProblemSet2Problem3:1060}
\begin{aligned}
...
\end{equation}
so
\begin{equation}\label{eqn:ProblemSet2Problem3:1080}
B
=
2
\trace{\lr{
...
\begin{equation}\label{eqn:ProblemSet2Problem3:1120}
\begin{aligned}
B
&=
2
...
\begin{equation}\label{eqn:ProblemSet2Problem3:1140}
j^{V,a}_\mu = 2 \expectation{H}^2 h(1 + h) \symmetric{ \phi^c}{\partial_\mu \phi^b} \epsilon^{abc},
\end{equation}
