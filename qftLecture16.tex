...
\begin{dmath}\label{eqn:qftLecture16:460}
...
There are no other possibilities for the first order (and these ones are not interesting).  For the second order transistion amplitudes we want to sum of all the contractions for the expectation
\begin{dmath}\label{eqn:qftLecture16:480}
...
\imageFigure{../figures/phy2403-quantum-field-theory/qftLecture16Fig9}{Another not-connected diagram.}{fig:qftLecture16:qftLecture16Fig9}{0.2}
...
\begin{dmath}\label{eqn:qftLecture16:500}
...
\begin{dmath}\label{eqn:qftLecture16:520}
...
\begin{dmath}\label{eqn:qftLecture16:540}
...
\begin{dmath}\label{eqn:qftLecture16:600}
...
\imageFigure{../figures/phy2403-quantum-field-theory/qftLecture16Fig13}{Other amputatable diagrams.}{fig:qftLecture16:qftLecture16Fig13}{0.2}

At the next order we can have fun interactions like that of \cref{fig:qftLecture16:qftLecture16Fig14}, which is not amputable (it connects branches), and must be considered.
...
\cref{fig:qftLecture16:qftLecture16Fig16}.
\imageFigure{../figures/phy2403-quantum-field-theory/qftLecture16Fig16}{CAPTION: qftLecture16Fig16}{fig:qftLecture16:qftLecture16Fig16}{0.2}
