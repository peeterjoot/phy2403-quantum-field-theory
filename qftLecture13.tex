...
We imagined that we have a windowed source function \( j(y^0, \By) \), as sketched in \cref{fig:windowedImpulse:windowedImpulseFig5}, which is acting as a forcing source for the non-homogeneous Klien-Gordon equation
...
H_{\text{int}, I}(t').
\end{dmath}
This integration range is the upper triangular region sketched in \cref{fig:upperTriangleIntegrationRegion:upperTriangleIntegrationRegionFig2}.
