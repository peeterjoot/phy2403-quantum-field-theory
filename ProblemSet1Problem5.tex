...
\begin{equation}\label{eqn:ProblemSet1Problem5:20}
E_{\text{zero point}} =
...
\begin{equation}\label{eqn:ProblemSet1Problem5:40}
\begin{aligned}
\Delta &E_{\text{vac}}(a) = \Hbar c \int_0^\infty \frac{dk}{2\pi} k  \, \times \\
&\quad\Biglr{ \frac{k}{4}
...
\begin{equation}\label{eqn:ProblemSet1Problem5:260}
\Delta E_{\text{vac}}(a)
=
...
\end{equation}
where
\begin{equation}\label{eqn:ProblemSet1Problem5:280}
...
\begin{equation}\label{eqn:ProblemSet1Problem5:120}
2 k_x a = 2 \pi n,
\end{equation}
which provides the
\begin{equation}\label{eqn:ProblemSet1Problem5:140}
k_x = \frac{\pi n}{a}
\end{equation}
...
\begin{equation}\label{eqn:ProblemSet1Problem5:160}
\begin{aligned}
\frac{E}{A}
&= \inv{A}
...
\begin{equation}\label{eqn:ProblemSet1Problem5:180}
\frac{E}{A}
= \frac{\Hbar c}{8 \pi} \int_{k = 0}^\infty k dk
\lr{ k + 2 \sum_{n = 1}^\infty \sqrt{ \lr{ \frac{n \pi}{a}}^2 + k^2 } }.
\end{equation}
...
\begin{equation}\label{eqn:ProblemSet1Problem5:200}
\begin{aligned}
\frac{E}{A}
...
Into the integrand of \cref{eqn:ProblemSet1Problem5:40}, we
introduce 
the cutoff function \( f(k) \),
and make a change of variables \( k = \pi x /a \) to find
\begin{equation}\label{eqn:ProblemSet1Problem5:220}
\begin{aligned}
\Delta &E_{\text{vac}}(a)
= \int_0^\infty \frac{dk}{2\pi} k 
\\ &\quad
\Biglr{
   \frac{k}{4} f(k)
   + \inv{2} \sum_{n = 1}^\infty \sqrt{ k^2 + \frac{n^2 \pi^2}{a^2} }
...
\end{equation}
Now let \( u = x^2 \)
\begin{equation}\label{eqn:ProblemSet1Problem5:240}
\begin{aligned}
\Delta &E_{\text{vac}}(a)
=
...
\begin{equation}\label{eqn:ProblemSet1Problem5:300}
F(n) = \int_{n^2}^\infty dv \sqrt{ v } f((\pi/a) \sqrt{v}),
\end{equation}
and utilize
\begin{equation}\label{eqn:ProblemSet1Problem5:320}
\frac{d}{du} \int_u^v f(t) dt = f(v) \frac{dv}{dt} - f(u) \frac{du}{dt},
\end{equation}
so the first derivative is
\begin{equation}\label{eqn:ProblemSet1Problem5:340}
\begin{aligned}
F'(n)
...
\end{equation}
the second is
\begin{equation}\label{eqn:ProblemSet1Problem5:360}
F''(n)
= -4 n f((\pi/a) n) - 2 n^2 (\pi/a) f'((\pi/a) n),
\end{equation}
the third is
\begin{equation}\label{eqn:ProblemSet1Problem5:380}
\begin{aligned}
F'''(n)
&=
-4 f((\pi/a) n)
...
\begin{equation}\label{eqn:ProblemSet1Problem5:400}
\begin{aligned}
F'(0) &= 0 \\
F''(0) &= 0 \\
F'''(0) &= -4 \\
...
\begin{equation}\label{eqn:ProblemSet1Problem5:420}
   \inv{2} F(0) + \sum_{n = 1}^\infty F(n) - \int_0^\infty dn F(n) = -\inv{2!} B_2 F'(0) - \inv{4!} B_4 F'''(0) + \cdots,
\end{equation}
so
\begin{equation}\label{eqn:ProblemSet1Problem5:440}
...
\begin{equation}\label{eqn:ProblemSet1Problem5:460}
\begin{aligned}
\Delta E_{\text{vac}}(a)
&=
...
\begin{equation}\label{eqn:ProblemSet1Problem5:500}
\frac
{
F_{\text{capacitor}}
}
