...
%
\makeoproblem{Observability of the zero point energy: the Casimir force.}{qft:problemSet1:5}{2018 HW1.V}{
...
\begin{eqnarray}
{1\over 2} F(0) + F(1) + F(2) + \ldots - \int\limits_{n=0}^\infty d n F(n) = - {1\over 2!} B_2 F^\prime(0) -
{1 \over 4!}B_4 F^{\prime \prime \prime } (0) + \ldots ~,
\end{eqnarray}
