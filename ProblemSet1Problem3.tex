...
%
%{
\makeoproblem{Zero point energy, and unit conversion.}{qft:problemSet1:3}{2018 Hw1.III}{
...
\begin{equation}\label{eqn:ProblemSet1Problem3:20}
...
\paragraph{The} results from the first three items above lead to a puzzle commonly referred to as the ``cosmological constant problem''.
...
\begin{equation}\label{eqn:ProblemSet1Problem3:40}
\begin{aligned}
E_{\text{vac}}
...
\begin{equation}\label{eqn:ProblemSet1Problem3:80}
\begin{aligned}
...
\begin{aligned}
(1 eV)^4
&= 1.78 \times 10^{-33} \lr{ \inv{1.97 \times 10^{-5}} }^3 \,\si{g/(cm)^3} \\
...
\begin{equation}\label{eqn:ProblemSet1Problem3:120}
\begin{aligned}
\rho_{\text{vac}}
&= \inv{16 \pi^2} (10^{13} eV)^4 \times 2.3 \times 10^{-19} \,\si{g/(cm)^3/(eV)^4} \\
...
\begin{equation}\label{eqn:ProblemSet1Problem3:140}
\begin{aligned}
\lambda
&= \lr{ 16 \pi^2 \rho }^{1/4} \\
...
\begin{equation}\label{eqn:ProblemSet1Problem3:160}
\begin{aligned}
\lambda
&= \frac{2 \pi}{k} = \frac{2 \pi}{9.1 \times 10^{-3} \,\si{eV}} \times 1.97 \times 10^{-5} (\si{eV})(\si{cm}) \\
&= 1.4 \times 10^{-2} \,\si{cm}.
\end{aligned}
\end{equation}
\makeSubAnswer{}{qft:problemSet1:3c}
The Planck mass is
\begin{equation}\label{eqn:ProblemSet1Problem3:180}
\begin{aligned}
M_{\text{Planck}}
...
\begin{equation}\label{eqn:ProblemSet1Problem3:200}
\begin{aligned}
\frac{\rho_{\text{vac (Planck)}}}{
\rho_{\text{dark}}}
&= \frac {\lr{ 10^{28} \,\si{eV} }^4} {\lr{ 10^{-2} \,\si{eV} }^4} \\
&= 10^{120}.
\end{aligned}
\end{equation}
