...
\widetilde{\phi}(\Bp, t) = \inv{\sqrt{2 \omega_\Bp}} \lr{ e^{-i \omega_\Bp t} a_\Bp + e^{i \omega_\Bp t} b^\dagger_\Bp },
\end{dmath}
...
\end{dmath}
\end{subequations}
By inspection, we may read off the Fourier transform of \( \widetilde{\pi^\dagger} \), which is
\begin{dmath}\label{eqn:ProblemSet1Problem2:960}
\widetilde{\pi^\dagger}(\Bp, t)
=
\frac{i\omega_\Bp}{\sqrt{2 \omega_\Bp}} \lr{ -e^{-i \omega_\Bp t} a_\Bp + e^{i \omega_\Bp t} b^\dagger_\Bp },
\end{dmath}
...
\begin{aligned}
a_\Bp &= e^{i\omega_\Bp t} \sqrt{\frac{\omega_\Bp}{2}} \lr{ \widetilde{\phi} - \inv{i \omega_\Bp} \widetilde{\pi^\dagger} } \\
b_\Bp^\dagger &= e^{-i\omega_\Bp t} \sqrt{\frac{\omega_\Bp}{2}} \lr{ \widetilde{\phi} + \inv{i \omega_\Bp} \widetilde{\pi^\dagger} },
\end{aligned}
\end{dmath}
...
\antisymmetric{a_\Bp^\dagger}{a_\Bq^\dagger}
=
\int d^3 x
d^3 y
e^{-i \Bp \cdot \Bx}
...
\antisymmetric{b_\Bp^\dagger}{b_\Bq^\dagger}
=
\int d^3 x
d^3 y
e^{i \Bp \cdot \Bx}
...
Inserting \cref{eqn:ProblemSet1Problem2:860} into
...
particles associated with creation operator \( b_\Bp^\dagger \) have a (-1/2) charge.  Since the leading factor in the charge of
\cref{eqn:ProblemSet1Problem2:580} was arbitrary (as it comes from examining the symmetry for the \( \phi \rightarrow e^{\pm i\alpha} \phi \) with \( \alpha = 1/2\)), it is perhaps more accurate to say that the number operator 
\( a_\Bp^\dagger a_\Bp \) is associated with a unit of charge whereas 
\( b_\Bp^\dagger b_\Bp \) is associated with a unit of charge with the opposite sign.
}
%}
