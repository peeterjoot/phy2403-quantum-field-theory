...
\section{Canonical quantization (cont.)}
...
H
= \int d^3 x
\lr{ \inv{2} \pi^2 + \inv{2} (\spacegrad \phi)^2 + \inv{2} m^2 \phi^2 + \frac{\lambda}{4} \phi^4 }.
\end{equation}
...
\calH(\Bx, t) =
\inv{2} \pi^2 + \inv{2} (\spacegrad \phi)^2 + \inv{2} m^2 \phi^2 + \frac{\lambda}{4} \phi^4.
\end{equation}
...
\hat{\calH}(\Bx, t)
=
\inv{2} \hat{\pi}^2 + \inv{2} (\spacegrad \hat{\phi})^2 + \inv{2} m^2 \hat{\phi}^2 + \frac{\lambda}{4} \hat{\phi}^4.
\end{equation}
